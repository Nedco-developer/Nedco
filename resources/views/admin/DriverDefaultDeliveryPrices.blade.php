...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div>
                <p>Click on the row cell to edit drivers default delivery price</p>
            </div>
            <!-- Regions -->
                    ...
                    <table id="regionstable" class="display nowrap table-res table table-condensed ">
                      <thead>
                        ...
                        <tbody>
                            <tr>
                                @foreach($locations as $location)
                                <td data-id="{{$location->id}}">{{$location->driver_price}}</td>
                                @endforeach
                            </tr>
                        </tbody>
                        <tfoot>
                    ...
                    <table id="citiestable" class="display nowrap table-res table table-condensed ">
                      <thead>
                        ...
                        <tbody>
                            <tr>
                                @foreach($cities as $city)
                                <td data-id="{{$city->id}}">{{$city->driver_price}}</td>
                                @endforeach
                            </tr>
                        </tbody>
                        <tfoot>
                ...
                <div id="Disricts" class="row justify-content-center tab-pane">
                    <table id="districtstable" class="display nowrap table-res table table-condensed ">
                        ...
                        <tbody>
                            <tr>
                                @foreach($districts as $district)
                                <td data-id="{{$district->id}}">{{$district->driver_price}}</td>
                                @endforeach
                            </tr>
                        </tbody>
                        <tfoot>
            ...
            const regionCell = function(cell) {
              ...
              cell.addEventListener('blur', function(e) {
                if (original !== e.target.textContent) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ route('updateDriverRegionPrice') }}",
                        data: {
                            _token,
                            id,
                            driver_price: e.target.textContent
                        },
            ...
            const cityCell = function(cell) {
              ...
              cell.addEventListener('blur', function(e) {
                if (original !== e.target.textContent) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ route('updateDriverCityPrices') }}",
                        data: {
                            _token,
                            id,
                            driver_price: e.target.textContent
            ...
            const districtCell = function(cell) {
              ...
              cell.addEventListener('blur', function(e) {
                if (original !== e.target.textContent) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ route('updateDriverDefaultDeliveryPrices') }}",
                        data: {
                            _token,
                            id,
                            driver_price: e.target.textContent
