    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('SubmitCities') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select required name="Region_id" id="Region_id" class="form-control">
                                    ...
                                    <option value="{{ $location->id }}">{{ $location->Region }}</option>z
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" name="city_code" id="city_code" class="form-control" />
                            </div>
                        </div>
