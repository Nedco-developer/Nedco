...
<div class="col-md-10">
    <div class="card">
        ...
        <div class="card-body">
            ...
            @endif
            <a class="btn btn-success" style="margin-bottom: 1rem;" href="/nedco/register-admin">Add</a>
                ...
                <tbody>
                    @foreach($Admin as $Admin)
                        <tr>
                            ...
                            <td><a href="editadmin?id={{ $Admin->user_id }}" class="btn btn-primary">edit</a>
                            </td>
                            <td>
                                <a href="deleteadmin?user_id={{ $Admin->user_id }}&id={{ $Admin->id }}"
