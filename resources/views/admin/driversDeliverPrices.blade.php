...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">Drivers Delivery Prices</div>
        <div class="card-body">
                ...
                <tbody>
                    @foreach($drivers as $driver)
                        <tr>
                            ...
                            @foreach($districts as $district)
                            <td data-id="{{$district->id}},{{$driver->user->id}}">
                               <?php 
                            //   getting user delivery price per distict
                               $districtsPrices = DistrictsPrices::where('user_id', $driver->user_id)->where('district_id', $district->id)->first();
