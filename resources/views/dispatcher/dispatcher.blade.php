...
.table-res{
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">Dispatchers</div>
            <div class="card-body">
                ...
                @endif
                <a class="btn btn-success" style="margin-bottom: 1rem;" href="/nedco/registerAdmin?name=dispatcher">Add</a>
                    ...
                    <tbody>
                        @foreach ($Admin as $admin)
                            <tr>
                                ...
                                <td>Inactive</td>
                                @endif
                                <td><a href="editdispatcher?id={{ $admin->user_id }}" class="btn btn-primary">edit</a>
                                </td>
                                <td>
                                    <a href="deletedispatcher?user_id={{ $admin->user_id }}&id={{ $admin->id }}"
