    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <a class="btn btn-success" style="margin-bottom: 1rem;" href="/nedco/registerAdmin?name=finance">Add</a>
                    ...
                    <tbody>
                        @foreach ($Admin as $Admin)
                            <tr>
                                ...
                                <td>Inactive</td>
                                @endif
                                <td><a href="editfinance?id={{ $Admin->user_id }}" class="btn btn-primary">edit</a>
                                </td>
                                <td>
                                    <a href="deletefinance?user_id={{ $Admin->user_id }}&id={{ $Admin->id }}"
